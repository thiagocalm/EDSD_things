...
# it is a kind of way to look at period effects
cw3 %>%
  ggplot()+
...
# TCA comment: we can change the parameters to have analysis by age
...
plot_change("USA", "female", 10, 80, 1950, 2021) + plot_change("USA", "male", 10, 80, 1950, 2021)
